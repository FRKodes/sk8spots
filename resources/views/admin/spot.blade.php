	...
	<div class="container spot-detail">
		...
		<div class="row">
			...
			<div class="col-sm-6 col-lg-7">
				...
				<p><b class="verde3">Ciudad: </b>{{ $spot->city }}</p>
				<p><b class="verde3">Estado: </b>{{ $spot->state }}</p>
				<p><b class="verde3">País: </b>{{ $spot->country }}</p>
				<p><b class="verde3">Categoría: </b>{{ $spot->category_id }}</p>
